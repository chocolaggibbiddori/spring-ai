...
@Component
public class Exam05AttractionAgent {
    ...
    public Exam05AttractionAgent(ChatClient.Builder chatClientBuilder, InternetSearchService searchService) {
