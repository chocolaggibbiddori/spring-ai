...
public class Exam08YoutubeSearchAgent {
    ...
    public Exam08YoutubeSearchAgent(ChatClient.Builder chatClientBuilder,
    ...
    @Tool(description = """
            ...
            """)
    public String searchYoutubeVideos(@ToolParam(description = "검색 키워드 (예: '서울 여행', '부산 맛집')") String query) {
        try {
            // 검색 API 호출
